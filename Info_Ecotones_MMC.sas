...
USE 'ALLPERM' INSTEAD OF 'ALLCOMB' IF ORDER IS IMPORTANT
*****************************************************************************************************;

%let root= C:\Users\dylanb\; *select the correct drive root for you computer    D:\    or    C:\Users\dburruss\    ;
%let fpath=&root.Dropbox\SAS\Dust_Project\FINAL DUST ANALYSIS\Informing_Ecotone_Boundaries\;
